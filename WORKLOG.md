...
- 当前运行版本：Relay.app **v0.84.0 (110)**（`~/Applications`）、cli-adapters 0.3.1、relay-protocol 0.3.0、relayd **0.9.4**、协议 v8；daemon 在线，注册 Claude / Codex / MIX / Ollama / Grok（grok 经用户目录 generic manifest 接入）。
