...
- 分支已整理：Codex 侧栏分支（v0.104–v0.106.2 五个提交）连同 v0.107.0 提交已快进合并回 `main`（@ `b8cf99b`）并删除分支，历史保持单线；v0.108.0（头部电路）与 v0.109.0（daemon 行按需显示、双开入坞）为工作树未提交改动；纯本地、无远端推送。历史里程碑：`ed6e9a4`（→v0.78）、`afcaf83`、`78eb3f7`（→v0.93）、`dc2d62d`（→v0.101.2）、`94ffc24`（文档）、`c362a06`（→v0.103）、`0543822`（交接）、`8b1dcb7`（→v0.104）。
