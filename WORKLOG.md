...
### 当前状态（随迭代更新，2026-07-20 更新至 v0.106.1）
...
- 当前运行版本：Relay.app **v0.106.1 (138)**（`~/Applications`）、cli-adapters 0.4.0、relay-protocol 0.3.0、relayd **0.9.5**、协议 v8；daemon 在线，注册 Claude / Codex / MIX / Ollama / Grok（grok 经用户目录 generic manifest 接入）；ACP CLI 可经 `acp` manifest 接入（本机装有 claude-code-acp 可作真实 ACP 目标）。
